...
const gsiCriteria = [
  {
    ...
    subCriteria: [
      { id: 'sti1', name: 'มีการจัดการการใช้ที่ดินและพื้นที่สีเขียวอย่างยั่งยืนหรือไม่', maxScore: 6 },
      { id: 'sti2', name: 'ส่งเสริมการเดินทางที่ยั่งยืน (เดิน จักรยาน ขนส่งสาธารณะ)', maxScore: 5 },
      { id: 'sti3', name: 'มีโครงสร้างพื้นฐานรองรับการเดินทางคาร์บอนต่ำ/EV', maxScore: 5 },
      { id: 'sti4', name: 'พื้นที่และโครงสร้างพื้นฐานเข้าถึงได้สำหรับทุกคน', maxScore: 5 }
    ]
  },
  {
    id: 'wmr',
    ...
    subCriteria: [
      { id: 'wmr1', name: 'มีการวัดและลดการใช้น้ำอย่างเป็นระบบ', maxScore: 5 },
      { id: 'wmr2', name: 'ใช้น้ำทางเลือกหรือนำน้ำกลับมาใช้ซ้ำ', maxScore: 4 },
      { id: 'wmr3', name: 'มีระบบลดของเสียและการรีไซเคิล', maxScore: 4 },
      { id: 'wmr4', name: 'การจัดซื้อวัสดุอย่างยั่งยืน', maxScore: 4 },
      { id: 'wmr5', name: 'สนับสนุนแนวคิดเศรษฐกิจหมุนเวียน', maxScore: 4 }
    ]
  },
  {
    id: 'ecc',
    ...
    subCriteria: [
      { id: 'ecc1', name: 'มีข้อมูลและการติดตามการใช้พลังงาน', maxScore: 5 },
      { id: 'ecc2', name: 'มีมาตรการเพิ่มประสิทธิภาพพลังงาน', maxScore: 5 },
      { id: 'ecc3', name: 'ใช้พลังงานหมุนเวียนหรือคาร์บอนต่ำ', maxScore: 4 },
      { id: 'ecc4', name: 'คำนวณและรายงานการปล่อย GHG', maxScore: 4 },
      { id: 'ecc5', name: 'มีเป้าหมาย/แผนลดคาร์บอน', maxScore: 4 }
    ]
  },
  {
    id: 'hwq',
    ...
    subCriteria: [
      ...
      { id: 'hwq2', name: 'มาตรการด้านสุขภาพและความปลอดภัย', maxScore: 3 },
      { id: 'hwq3', name: 'การเข้าถึงและการออกแบบเพื่อทุกคน', maxScore: 3 }
    ]
  },
  {
    id: 'gpm',
    ...
    subCriteria: [
      ...
      { id: 'gpm2', name: 'มีแผน เป้าหมาย และตัวชี้วัด', maxScore: 1 },
      { id: 'gpm3', name: 'มีการรายงานและปรับปรุงต่อเนื่อง', maxScore: 1 }
    ]
  },
  {
    id: 'ilp',
    ...
    subCriteria: [
      { id: 'ilp1', name: 'มีนวัตกรรมที่เกินเกณฑ์มาตรฐาน', maxScore: 4 },
      { id: 'ilp2', name: 'ตอบโจทย์บริบทพื้นที่/ชุมชน', maxScore: 3 }
    ]
  },
  {
    id: 'ere',
    ...
    subCriteria: [
      { id: 'ere1', name: 'นโยบายโรงเรียนสีเขียว', maxScore: 3 },
      { id: 'ere2', name: 'แผนงานและงบประมาณที่ชัดเจน', maxScore: 3 },
      { id: 'ere3', name: 'ระบบติดตามและรายงานผล', maxScore: 3 },
      { id: 'ere4', name: 'การพัฒนาและปรับปรุงอย่างต่อเนื่อง', maxScore: 3 },
      { id: 'ere5', name: 'การถ่ายทอดสู่ชุมชน/สังคม', maxScore: 3 }
    ]
  }
];
...
const scoringGuideData = {
  sti: {
    ...
    nameLocal: 'พื้นที่ การเดินทาง และโครงสร้างพื้นฐาน',
    levels: [
      { score: 0, label: 'ไม่มีการจัดการ', desc: 'ไม่มีนโยบาย มาตรการ หรือข้อมูลที่เกี่ยวข้องกับเกณฑ์ดังกล่าว' },
      { score: 1, label: 'ขั้นพื้นฐาน', desc: 'มีการดำเนินการหรือสิ่งอำนวยความสะดวกในระดับเริ่มต้น แต่ยังไม่เป็นระบบ' },
      { score: 2, label: 'เริ่มดำเนินการ', desc: 'มีการดำเนินการในบางส่วน แต่ยังจำกัดเฉพาะบางพื้นที่หรือบางกิจกรรม' },
      { score: 3, label: 'ดำเนินการทั่วไป', desc: 'มีการดำเนินการที่ชัดเจนในหลายพื้นที่ และเริ่มมีการใช้งานจริง' },
      { score: 4, label: 'ดำเนินการอย่างเป็นระบบ', desc: 'มีมาตรการหรือแนวทางที่ชัดเจน ครอบคลุมพื้นที่หลัก และมีการใช้งานอย่างต่อเนื่อง' },
      { score: 5, label: 'พัฒนาอย่างต่อเนื่อง', desc: 'มีการติดตามผล ปรับปรุง และพัฒนาอย่างต่อเนื่อง ครอบคลุมพื้นที่ส่วนใหญ่' },
      { score: 6, label: 'คุณภาพสูง', desc: 'มีการดำเนินงานครอบคลุมทั้งหมด เป็นระบบ มีประสิทธิภาพสูง และสามารถเป็นต้นแบบได้' },
    ]
  },
  wmr: {
    name: 'Water & Material Resources',
    nameLocal: 'น้ำและทรัพยากรวัสดุ',
    levels: [
      { score: 0, label: 'ไม่มีการดำเนินการ', desc: 'ไม่มีข้อมูล นโยบาย หรือการดำเนินงานที่เกี่ยวข้องกับเกณฑ์ดังกล่าว' },
      { score: 1, label: 'ขั้นเริ่มต้น', desc: 'มีแนวคิดหรือการดำเนินการเล็กน้อยในบางส่วน แต่ยังไม่ชัดเจนหรือไม่ต่อเนื่อง' },
      { score: 2, label: 'ดำเนินการบางส่วน', desc: 'มีการดำเนินงานในบางกิจกรรมหรือบางพื้นที่ แต่ยังไม่ครอบคลุมและยังไม่เป็นระบบ' },
      { score: 3, label: 'ดำเนินการอย่างชัดเจน', desc: 'มีการดำเนินงานในหลายส่วน ใช้งานได้จริง และเริ่มมีความต่อเนื่องหรือการติดตามผล' },
      { score: 4, label: 'ดำเนินการอย่างเป็นระบบ', desc: 'มีการดำเนินงานครอบคลุม เป็นระบบ มีการติดตามผลอย่างต่อเนื่อง และเห็นผลลัพธ์ชัดเจน' },
      { score: 5, label: 'ระดับองค์กร/ต้นแบบ', desc: 'ดำเนินการอย่างครบถ้วนทั้งองค์กร มีประสิทธิภาพสูง เห็นผลลัพธ์ชัดเจน และสามารถเป็นต้นแบบหรือขยายผลได้' }
    ]
  },
  ecc: {
    name: 'Energy, Carbon & Climate',
    nameLocal: 'พลังงาน คาร์บอน และสภาพภูมิอากาศ',
    levels: [
      { score: 0, label: 'ไม่มีการดำเนินการ', desc: 'ไม่มีข้อมูล มาตรการ หรือการดำเนินงานที่เกี่ยวข้องกับเกณฑ์ด้านพลังงาน' },
      { score: 1, label: 'ขั้นเริ่มต้น', desc: 'มีข้อมูลหรือมาตรการพื้นฐานเล็กน้อย แต่ยังไม่ต่อเนื่องหรือไม่ชัดเจน' },
      { score: 2, label: 'ดำเนินการบางส่วน', desc: 'มีการดำเนินงานในบางส่วน เช่น เริ่มเก็บข้อมูลหรือมีมาตรการบางกิจกรรม แต่ยังไม่เป็นระบบ' },
      { score: 3, label: 'ดำเนินการอย่างชัดเจน', desc: 'มีการดำเนินงานอย่างต่อเนื่องในหลายส่วน มีระบบเบื้องต้น และเริ่มเห็นผลลัพธ์หรือมีการติดตาม' },
      { score: 4, label: 'ดำเนินการอย่างเป็นระบบ', desc: 'มีระบบที่ชัดเจน ครอบคลุมการดำเนินงาน มีการวิเคราะห์ข้อมูลและปรับปรุงอย่างต่อเนื่อง' },
      { score: 5, label: 'ระดับองค์กร/เชิงกลยุทธ์', desc: 'มีการดำเนินงานครบถ้วนทั้งองค์กร ใช้ข้อมูลเชิงวิเคราะห์ในการบริหารจัดการ เห็นผลลัพธ์ชัดเจน และพัฒนาอย่างต่อเนื่องในระยะยาว' }
    ]
  },
  hwq: {
    name: 'Health, Wellbeing & Quality of Life',
    nameLocal: 'สุขภาพ ความเป็นอยู่ที่ดี และคุณภาพชีวิต',
    levels: [
      { score: 0, label: 'ไม่เป็นไปตามมาตรฐานพื้นฐาน', desc: 'ไม่มีมาตรการหรือการดำเนินงานที่เกี่ยวข้อง และไม่เป็นไปตามเกณฑ์ขั้นต่ำ' },
      { score: 1, label: 'ขั้นพื้นฐาน', desc: 'มีมาตรการหรือสิ่งอำนวยความสะดวกเบื้องต้นในบางด้าน แต่ยังไม่ครอบคลุม' },
      { score: 2, label: 'ดำเนินการบางส่วน', desc: 'มีการดำเนินงานในหลายด้าน และเริ่มมีระบบหรือการควบคุมบางส่วน' },
      { score: 3, label: 'ดำเนินการอย่างชัดเจน', desc: 'มีระบบดูแลหรือควบคุมที่ชัดเจน ครอบคลุมพื้นที่หลัก และสามารถใช้งานได้จริง' },
      { score: 4, label: 'ดำเนินการอย่างเป็นระบบและมีคุณภาพสูง', desc: 'มีระบบครบถ้วน ครอบคลุมทุกด้าน มีการติดตาม ประเมินผล และปรับปรุงอย่างต่อเนื่อง' }
    ]
  },
  gpm: {
    name: 'Governance, Planning & Management',
    nameLocal: 'การกำกับดูแล การวางแผน และการจัดการ',
    levels: [
      { score: 0, label: 'ไม่มีการดำเนินการ', desc: 'ไม่มีโครงสร้าง แผน เป้าหมาย หรือการรายงานที่เกี่ยวข้องกับความยั่งยืน' },
      { score: 1, label: 'ขั้นเริ่มต้น', desc: 'มีการดำเนินการในบางส่วน เช่น มีผู้รับผิดชอบหรือมีแผน/การรายงาน แต่ยังไม่ครบถ้วนหรือยังไม่เชื่อมโยงกับการดำเนินงานจริง' },
      { score: 2, label: 'ดำเนินการอย่างเป็นระบบ', desc: 'มีโครงสร้าง แผน เป้าหมาย และการรายงานที่ชัดเจน เชื่อมโยงกับการดำเนินงานจริง และมีการติดตามปรับปรุงอย่างต่อเนื่อง' }
    ]
  },
  ilp: {
    name: 'Innovation & Local Priorities',
    nameLocal: 'นวัตกรรมและความสำคัญในพื้นที่',
    levels: [
      { score: 0, label: 'ไม่มีการดำเนินการ', desc: 'ไม่มีนวัตกรรม หรือไม่คำนึงถึงบริบทพื้นที่และชุมชน' },
      { score: 1, label: 'ขั้นเริ่มต้น', desc: 'มีแนวคิดหรือโครงการทดลอง หรือเริ่มคำนึงถึงบริบท แต่ยังไม่ได้นำไปใช้จริงหรือผลลัพธ์ยังไม่ชัดเจน' },
      { score: 2, label: 'ดำเนินการบางส่วน', desc: 'มีการนำไปใช้จริงในบางส่วน หรือเริ่มปรับใช้กับบริบทพื้นที่และชุมชน แต่ยังไม่ครอบคลุม' },
      { score: 3, label: 'ดำเนินการอย่างชัดเจน', desc: 'นวัตกรรมใช้งานได้จริง เห็นผลลัพธ์เชิงบวก และสอดคล้องกับบริบทพื้นที่อย่างชัดเจน' },
      { score: 4, label: 'ระดับโดดเด่น/ต้นแบบ', desc: 'มีนวัตกรรมที่โดดเด่น เห็นผลชัดเจน สร้างผลกระทบเชิงบวก และสามารถขยายผลหรือเป็นต้นแบบได้' }
    ]
  },
  ere: {
    name: 'Education, Research & Engagement',
    nameLocal: 'การศึกษา งานวิจัย และการมีส่วนร่วม',
    levels: [
      { score: 0, label: 'ไม่มีการดำเนินการ', desc: 'ไม่มีการบูรณาการ งานวิจัย การเรียนรู้แบบลงมือทำ การมีส่วนร่วม หรือการถ่ายทอดองค์ความรู้ด้านความยั่งยืน' },
      { score: 1, label: 'ขั้นเริ่มต้น', desc: 'มีการดำเนินการในบางส่วน เช่น ในบางรายวิชา โครงการทดลอง หรือกิจกรรมเป็นครั้งคราว แต่ยังไม่ต่อเนื่องหรือไม่เป็นระบบ' },
      { score: 2, label: 'ดำเนินการอย่างชัดเจน', desc: 'มีการดำเนินงานในหลายด้าน เช่น หลายหลักสูตร งานวิจัยต่อเนื่อง หรือกิจกรรมที่ใช้งานจริง และเริ่มเชื่อมโยงกับสังคมหรือการเรียนรู้จริง' },
      { score: 3, label: 'ดำเนินการอย่างเป็นระบบและโดดเด่น', desc: 'มีการดำเนินงานครอบคลุม เป็นระบบต่อเนื่อง บูรณาการในระดับองค์กร และสร้างผลกระทบเชิงบวกหรือสามารถขยายผลได้' }
    ]
  }
};
