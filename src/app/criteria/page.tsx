...
const ratingLevels = [
  { level: 'PLATINUM', range: '70-100 คะแนน', color: 'from-slate-400 to-slate-600', score: '70%+' },
  { level: 'GOLD', range: '55-69 คะแนน', color: 'from-yellow-400 to-amber-500', score: '55-69%' },
  { level: 'SILVER', range: '45-54 คะแนน', color: 'from-gray-300 to-gray-400', score: '45-54%' },
  { level: 'BRONZE', range: '35-44 คะแนน', color: 'from-orange-400 to-orange-600', score: '34-44%' },
  { level: 'ไม่ผ่าน', range: '0-34 คะแนน', color: 'from-red-400 to-red-600', score: '<34%' }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 rounded-2xl p-8 md:p-12 border-2 border-primary/20 dark:border-primary/30 animate-fade-in mb-16">
          ...
          <p className="text-center font-body text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            คะแนนเต็ม 100 คะแนน จากการประเมิน 4 ด้านหลัก
              ...
              <table className="w-full font-body">
                <thead>
                  <tr className="border-b-2 border-primary/20 dark:border-slate-600">
                    ...
                    <th className="text-center py-4 px-4 font-semibold text-gray-900 dark:text-white">คะแนน (LEED) คิดเป็น%</th>
                    <th className="text-center py-4 px-4 font-semibold text-gray-900 dark:text-white">คะแนน (AASHE) คิดเป็น%</th>
                    <th className="text-center py-4 px-4 font-semibold text-primary dark:text-secondary">คะแนนGSI</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">Site, Transportation & Infrastructure</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">(13.6+10)%</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">(6.4+13)%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">21</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">Water & Material Resources</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">(8.2+16.4)%</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">17%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">21</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">Energy, Carbon & Climate</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">30%</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">13%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">22</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">Health, Wellbeing & Quality of Life</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">11.8%</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">7.1%</td>
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">7.1%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">4</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">Innovation & Local Priorities</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">9%</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">6.4%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">7</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">30%</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">15</td>
                  </tr>
                  <tr className="bg-primary/5 dark:bg-primary/10 font-semibold">
                    <td className="text-Left py-4 px-4 font-semibold text-primary dark:text-secondary">คะแนนเต็ม GSI กำหนดไว้ที่ 100 คะแนน </td>
                    <td className="py-4 px-4 text-sm text-center text-gray-900 dark:text-white"></td>
                    <td className="py-4 px-4 text-sm text-center text-gray-900 dark:text-white"></td>
                    <td className="py-4 px-4 text-sm text-center text-primary dark:text-secondary">100</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full font-body">
                <thead>
                  <tr className="border-b-2 border-primary/20 dark:border-slate-600">
                    ...
                    <th className="text-center py-4 px-4 font-semibold text-primary dark:text-secondary">GSI (100)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">80-110 (72.7%)</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">≥ 85 (34%)</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary"> 70-100</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">60-79 (54.5%)</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">65-84 (26%)</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">55-69</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">50-59 (45.4%)</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">45-64 (18%)</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">45-54</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">40-49 (36.3%)</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">25-44 (10%)</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">35-44</td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">0-39</td>
                    <td className="py-3 px-4 text-sm text-center text-gray-700 dark:text-gray-300">0-24</td>
                    <td className="py-3 px-4 text-sm text-center font-semibold text-primary dark:text-secondary">0-34</td>
                  </tr>
                </tbody>
              </table>
            </div>
