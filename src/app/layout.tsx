...
import { MapPin, Phone, Mail, Facebook, MessageCircle, BookOpen } from 'lucide-react';
...
export default function RootLayout({
  ...
  return (
    <html lang="th" className={baiJamjuree.variable} suppressHydrationWarning>
      <body className="font-body antialiased bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-50 transition-colors">
        <ThemeProvider>
          <ToastProvider>
            <Navbar />
            <main>{children}</main>

        <footer className="bg-gradient-to-r from-primary to-secondary dark:from-slate-800 dark:to-slate-700 text-white py-6 mt-20">
          ...
          >
            ...
            <span>คู่มือการประเมินฉบับเต็ม</span>
          </a>
